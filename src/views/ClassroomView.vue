...
<template>
  <div class="classroom-container p-5 max-w-5xl mx-auto bg-white shadow-md rounded-lg">
    ...
    <table class="classroom-table w-full border-collapse rounded-lg overflow-hidden mt-2">
      ...
      <tbody>
        <tr v-for="classroom in classrooms" :key="classroom._id.$oid" class="hover:bg-gray-100">
          <td class="p-3 border-b border-gray-300">{{ classroom.title }}</td>
          <td class="p-3 border-b border-gray-300">{{ classroom.details }}</td>
          <td class="p-3 border-b border-gray-300">{{ classroom.type }}</td>
          <td class="p-3 border-b border-gray-300">{{ classroom.format }}</td>
          <td class="p-3 border-b border-gray-300">{{ classroom.capacity }}</td>
